...
#include <occupancy_grid_msgs/masses.h>
...
private:
  ...
  occupancy_grid_msgs::masses masses_msg;
  ...
  void ray_tracing_horizontal_fill(int x2);
  void ray_tracing_horizontal_n_fill(int x2);
  void ray_tracing_vertical_n_fill(int y2);
  void ray_tracing_vertical_fill(int y2);
