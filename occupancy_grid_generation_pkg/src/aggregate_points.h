...
namespace occupancy_grid_generation_pkg
{
  ...
  //   void setVehicle(occupancy_grid_msgs::VehicleData vehicle);
  //
  //   private:
  //     // int device_id;
  //     // int beam_id;
  ...
  //
  //     occupancy_grid_msgs::VehicleData vehicle;
  //     double E_m = 0.0;
  //     double N_m = 0.0;
  //
  ...
  class AggregatePoints : public nodelet::Nodelet
  {
    ...
    private:
      ...
      occupancy_grid_msgs::VehicleData vehicle_msg;
      // CloudFilter filter;
      ...
      void vehicleCallback(const occupancy_grid_msgs::vehicle_state& vehicleState);
